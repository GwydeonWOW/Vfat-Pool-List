...
async function fetchVFatChain(chainId) {
  ...
  for (const farm of farms) {
    ...
    pools.push({
      ...
      activePoolLiquidity: parseFloat((snap.activePoolLiquidity || 0).toFixed(2)),
      rewardedLiquidity: parseFloat((snap.rewardedLiquidity || 0).toFixed(2)),
      stakedLiquidity: parseFloat((snap.stakedLiquidity || 0).toFixed(2)),
